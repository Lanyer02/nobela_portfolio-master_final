...
const Contact = () => {
  return (
    <div name="contact" className="bg-black w-full h-full text-white">
      <div className="p-4 mx-auto flex flex-col justify-center w-full h-full max-w-screen-xl">
        ...
        <div className='flex justify-center items-center'>
          <form 
            ...
            method='POST' 
            className='flex flex-col w-full sm:w-5/6 md:w-2/3 lg:w-1/2 max-w-md bg-gray-800 p-8 shadow-2xl transform transition-transform duration-300'
          >
              <div className="mb-6">
                <input
                  type="text"
