      ...
      <div className="max-w-screen-xl p-4 mx-auto flex flex-col justify-center">
        ...
        {selectedCert && (
          <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50">
            <div className="relative bg-white p-4 rounded shadow-lg text-black max-w-lg w-full">
              <button 
              ...
              <img src={selectedCert.src} alt={selectedCert.title} className="w-full h-auto" />
